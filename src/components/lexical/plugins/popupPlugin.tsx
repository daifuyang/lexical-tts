...
import { $getSelection, $isParagraphNode, $isRangeSelection, $isTextNode, COMMAND_PRIORITY_LOW, LexicalEditor, SELECTION_CHANGE_COMMAND } from "lexical";
...
function Popup(props: PopopProps) {
    ...
    return (
        <div ref={popupCharStylesEditorRef} className="lexical-popup">popup</div>
    )

}

function usePopup(editor: LexicalEditor,
    anchorElem: HTMLElement): JSX.Element | null {
